...
routePIA_A.RouteID='ROUTE_ID_001';
...
routePIA_B.RouteID='ROUTE_ID_002';
routePIA_B.GPSid='A123999RERE';
routePIA_B.Legs=[];
...
//console.log(schedule.GetAllRoutesDetailStatus());
console.log(schedule.GetScheduleWholeStatus());
//let a=JSON.stringify(schedule.GetScheduleWholeStatus());
//console.log(a);
